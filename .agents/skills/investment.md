...
This section defines the agreed construction rules for this portfolio. Reference these in every advisor council response, screener recommendation, and rebalancing suggestion. Do not override these defaults unless the user explicitly asks to revisit them.
...
|---|---|
| Horizon | 7–10 years |
| Drawdown behaviour | Rational — reviews with this tool, cautious buyer on dips, does not panic-sell |
| Deployment method | SIP (monthly) + opportunistic lump sums on quality dips |
| Primary goal | Beat inflation + steady compounding (not max CAGR, not capital preservation) |
...
| Sector | Target Weight | Notes |
|---|---|---|
| IT / Software | 12–15% | Core; dollar-earning; quality moats |
| Pharma / Healthcare | 10–12% | Defensive; domestic + export |
| FMCG / Consumer Staples | 8–10% | Defensive ballast; inflation pass-through |
| Industrial / Capital Goods | 10–12% | India capex cycle; Sharia-friendly |
| Auto / Auto Ancillary | 8–10% | Cyclical; strong long-term India story |
| Energy (non-banking) | 7–10% | GAIL-type; stable cash flows |
| Consumer Discretionary | 8–10% | Aspirational India growth |
| Specialty Chemicals | 5–8% | Mid/small cap alpha; Sharia check required |
| Healthcare Devices / Diagnostics | 5–8% | Optional; growing, typically Sharia-clean |

### Current Portfolio Gaps (as of April 2026)

- IT is overweight at 3/11 stocks — do not add more IT; cap at 15% value weight as portfolio grows
- No Auto / Auto Ancillary — first new sector to fill via SIP
- No Specialty Chemicals — small-cap alpha slot; add after Sharia + screener check
- Only 1 FMCG (HUL) — add a second as portfolio grows to 15+ stocks
- 11 stocks currently — grow by adding new sectors, not concentrating existing ones

### Growth Rule

> **Always grow the portfolio by filling sector gaps first. Never add a 4th stock to an existing sector before all 8 target sectors have at least 1 holding.**

### Benchmarking Policy

- Do NOT benchmark against Nifty 50 (37% financials = structurally unavailable)
- Track personal XIRR; compare informally against Nifty 500 ex-financials or Nifty500 Shariah Index
- Portfolio construction and benchmarking are separate problems — build right first, measure alpha second

### SIP Deployment Rule

When deploying monthly SIP or lump sums:
1. Check which sectors are underweight vs target map above
...
4. Never chase a stock that is already at/above 52-week high unless there is a specific catalyst
